...
from dolfinx_iga.splines.change_basis_1D import create_cardinal_extraction_operators
...
Cs = create_cardinal_extraction_operators(space)
...
for i in range(space.get_num_intervals()):
    ...
    C = Cs[i]
    bases = evaluate_cardinal_Bspline_basis(degree, tt) @ C.T
